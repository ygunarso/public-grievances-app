...
const xss = require('xss'); // xss checking
...
router.post('/signup', async (req, res) => {
    let userInfo = xss(req.body); // xss ussed
    if (!userInfo) {
...
router.post('/adminLogin', async (req, res) => {
    try {
        ...
        let login_form_parameters = xss(req.body); // xss used
...
router.post('/profileupdate', async (req, res) => {
    const requestBody = xss(req.body); //xss used
    let updatedObject = {};
    try {
